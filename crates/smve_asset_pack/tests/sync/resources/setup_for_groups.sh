...
cargo run -p smve_asset_pack_compiler -- -a asset_group_override1 -o override1.smap
cargo run -p smve_asset_pack_compiler -- -a asset_group_override2 -o override2.smap
